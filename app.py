...
<body>
    <div class="container">
        ...
        <form id="bot-form">
            ...
            <button type="button" class="btn btn-danger" id="stop-btn" style="display:none">🛑 STOP BOT</button>
        </form>
        
        <div style="margin-top:30px">
            <h3 style="color:#00ffff;margin-bottom:15px">📊 Live Logs</h3>
    ...
    <script>
        ...
        function updateStatus(online) {
            if (online) {
                statusIcon.style.background = '#00ff88';
        ...
        function addLog(msg) {
            ...
            if (msg.includes('SUCCESS') || msg.includes('✅')) div.classList.add('log-success');
            else if (msg.includes('FAILED') || msg.includes('💥') || msg.includes('ERROR')) div.classList.add('log-error');
        ...
        // Auto-connect logs and check status
        connectLogs();
        setInterval(() => {
